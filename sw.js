// Nombre de la caché (puedes cambiar 'v2' si haces futuras actualizaciones)
const CACHE_NAME = 'control-personal-v2';
    ...
    event.respondWith(
        caches.match(event.request)
            .then((response) => {
                ...
                // (Importante para las librerías que cargan otras dependencias)
